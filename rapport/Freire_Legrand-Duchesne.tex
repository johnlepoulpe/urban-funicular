...
\input{includes/question6-1.tex}
\subsection{Lien entre le domaine et le nombre de lignes dupliquées}
\input{includes/question6-2.tex}

\clearpage
\section*{Annexe}
\lstinputlisting{../Freire_Legrand-Duchesne.R}
